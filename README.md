...
3. **Форми.** `exchangeForm` і `callbackForm` зараз лише показують повідомлення
   про успіх — підключіть відправку на пошту / у Telegram / у CRM.
4. **Новини** — три демонстраційні матеріали без окремих сторінок.
5. **Відгуки** — тексти й портрети згенеровані як приклад.
...
Зелений залишився **тільки як акцент, не як колір для читання**:
...
Найгірший показник на сайті — **8,4:1** (WCAG AAA вимагає 7:1).
